    ...
    <div class="col-md-4" align="center">        
        ...
        <form method="post">                        
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Masukan Username" name="user" autofocus />
            </div>
            <div class="form-group">            
                <label>Password</label>
                <input type="password" id="inputPassword" class="form-control" placeholder="Masukan Password" name="pass" />  
            </div>      
            <div class="form-group">                
